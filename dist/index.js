...
`;function a(t){return String(t??"").trim().toLowerCase()}function s(t){let e=a(t);return"book"===e?"textbook":"hearing"===e?"presentation":"visibility"===e?"slides":"textbook"===e||"presentation"===e||"slides"===e?e:e.includes("textbook")||e.includes("lehrbuch")?"textbook":e.includes("presentation")||e.includes("präsent")?"presentation":e.includes("slides")||e.includes("folien")?"slides":null}function p(){let t=function(){let t=new Set;function e(e){try{e&&e.documentElement&&t.add(e)}catch(t){}}try{let t=window;for(let n=0;n<12&&(e(t.document),t.parent&&t.parent!==t);n++)t=t.parent}catch(t){}for(let n of Array.from(t))try{n.querySelectorAll("iframe").forEach(t=>{try{e(t.contentDocument)}catch(t){}})}catch(t){}return Array.from(t)}(),e=t.filter(t=>{try{return!!t.querySelector("[data-lia-only]")}catch(t){return!1}}),n=e.length?e:[document];for(let t of n)!function(t){try{let e=t.head||t.getElementsByTagName("head")[0]||t.documentElement;if(!e||t.getElementById(i))return;let n=t.createElement("style");n.id=i,n.appendChild(t.createTextNode(l)),e.appendChild(n)}catch(t){}}(t);let o=null;for(let e of t)if(o=function(t){let e=t.defaultView;return function(t){let e=Array.from(t.querySelectorAll(".material-icons, i.material-icons, span.material-icons")),n=null;for(let o of e){let e=s(a(o.textContent));if(!e)continue;let r=o.closest("button,[role='button'],a"),i=(r||o).getBoundingClientRect(),l=t.defaultView.innerWidth||1200,p=0;i.top<140&&(p+=200),i.left>.55*l&&(p+=200),r&&function(t){let e=a(t.getAttribute("aria-pressed")),n=a(t.getAttribute("aria-selected")),o=a(t.className);return"true"===e||"true"===n||o.includes("active")||o.includes("selected")||o.includes("mdc-icon-button--on")}(r)&&(p+=1e3),(!n||p>n.score)&&(n={mode:e,score:p})}return n?n.mode:null}(t)||function(t){for(let e of[t.querySelector("#app"),t.querySelector("main"),t.querySelector(".markdown-body"),t.body,t.documentElement].filter(Boolean)){let t=s([e.getAttribute&&e.getAttribute("data-mode"),e.getAttribute&&e.getAttribute("data-view"),e.getAttribute&&e.getAttribute("mode"),e.className,e.id].map(t=>String(t||"")).join(" "));if(t)return t}return null}(t)||s(a(e.location.search)+"&"+a(e.location.hash))||function(t){for(let e of[t.sessionStorage,t.localStorage].filter(Boolean))try{for(let t=0;t<e.length;t++){let n=e.key(t),o=e.getItem(n),r=s((n||"")+" "+(o||""));if(r)return r}}catch(t){}return null}(e)}(e))break;o||(o="unknown");let r="slides"===o||"presentation"===o||"textbook"===o;for(let t of n)try{r?t.documentElement.setAttribute("data-lia-mode",o):t.documentElement.removeAttribute("data-lia-mode")}catch(t){}}function u(){p(),setTimeout(p,50),setTimeout(p,250),setTimeout(p,1e3),document.addEventListener("click",()=>setTimeout(p,0),!0),window.addEventListener("hashchange",p,!0),window.addEventListener("popstate",p,!0)}},{"@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}]},["8RSWf"],"8RSWf","parcelRequirec2a1",{});
