...
`;function a(t){return String(t??"").trim().toLowerCase()}function s(t){let e=a(t);return"book"===e?"textbook":"hearing"===e?"presentation":"visibility"===e?"slides":"textbook"===e||"presentation"===e||"slides"===e?e:e.includes("textbook")||e.includes("lehrbuch")?"textbook":e.includes("presentation")||e.includes("präsent")?"presentation":e.includes("slides")||e.includes("folien")?"slides":null}function c(t){let e=function(){let t=new Set;function e(e){try{e&&e.documentElement&&t.add(e)}catch(t){}}try{let t=window;for(let n=0;n<12&&(e(t.document),t.parent&&t.parent!==t);n++)t=t.parent}catch(t){}for(let n of Array.from(t))try{n.querySelectorAll("iframe").forEach(t=>{try{e(t.contentDocument)}catch(t){}})}catch(t){}return Array.from(t)}(),n=e.filter(t=>{try{return!!t.querySelector("[data-lia-only]")}catch(t){return!1}}),i=n.length?n:[document];for(let t of i)!function(t){try{let e=t.head||t.getElementsByTagName("head")[0]||t.documentElement;if(!e||t.getElementById(o))return;let n=t.createElement("style");n.id=o,n.appendChild(t.createTextNode(l)),e.appendChild(n)}catch(t){}}(t);let r=t;if("unknown"===r)for(let t of e){let e=function(t){let e=t.defaultView;return function(t){let e=Array.from(t.querySelectorAll(".material-icons, i.material-icons, span.material-icons")),n=null;for(let i of e){let e=s(a(i.textContent));if(!e)continue;let r=i.closest("button,[role='button'],a"),o=(r||i).getBoundingClientRect(),l=t.defaultView.innerWidth||1200,c=0;o.top<140&&(c+=200),o.left>.55*l&&(c+=200),r&&function(t){let e=a(t.getAttribute("aria-pressed")),n=a(t.getAttribute("aria-selected")),i=a(t.className);return"true"===e||"true"===n||i.includes("active")||i.includes("selected")||i.includes("mdc-icon-button--on")}(r)&&(c+=1e3),(!n||c>n.score)&&(n={mode:e,score:c})}return n?n.mode:null}(t)||function(t){for(let e of[t.querySelector("#app"),t.querySelector("main"),t.querySelector(".markdown-body"),t.body,t.documentElement].filter(Boolean)){let t=s([e.getAttribute&&e.getAttribute("data-mode"),e.getAttribute&&e.getAttribute("data-view"),e.getAttribute&&e.getAttribute("mode"),e.className,e.id].map(t=>String(t||"")).join(" "));if(t)return t}return null}(t)||s(a(e.location.search)+"&"+a(e.location.hash))||function(t){for(let e of[t.sessionStorage,t.localStorage].filter(Boolean))try{for(let t=0;t<e.length;t++){let n=e.key(t),i=e.getItem(n),r=s((n||"")+" "+(i||""));if(r)return r}}catch(t){}return null}(e)}(t);if(e){r=e;break}}let c="slides"===r||"presentation"===r||"textbook"===r;for(let t of i)try{c?t.documentElement.setAttribute("data-lia-mode",r):t.documentElement.removeAttribute("data-lia-mode")}catch(t){}}function d(t){let e=()=>c(t());e(),setTimeout(e,50),setTimeout(e,250),setTimeout(e,1e3)}function p(t){c(t)}},{"@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],d6102:[function(t,e,n,i){var r=t("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"PRESENTER_BLACKOUT_ID",()=>c),r.export(n,"initPresenterSupport",()=>T),r.export(n,"syncPresenterSupport",()=>_);var o=t("./state"),l=t("./mode"),a=t("./reverseNavigation"),s=t("./keyboard");let c="lia-tff-presenter-blackout-v1",d="data-lia-tff-presenter-blackout",p=!1,u=!1;function f(){return o.ROOT_DOC===o.CONTENT_DOC?[o.CONTENT_DOC]:[o.CONTENT_DOC,o.ROOT_DOC]}function m(t){let e=String(t||"").trim().toLowerCase();return"presentation"===e||"slides"===e}function h(t,e,n){(t.style.getPropertyValue(e)!==n||"important"!==t.style.getPropertyPriority(e))&&t.style.setProperty(e,n,"important")}function g(){let t=o.ROOT_DOC.getElementById(c);if(!t){if(!o.ROOT_DOC.body)return null;(t=o.ROOT_DOC.createElement("div")).id=c,o.ROOT_DOC.body.appendChild(t)}"true"!==t.getAttribute("aria-hidden")&&t.setAttribute("aria-hidden","true"),"presentation"!==t.getAttribute("role")&&t.setAttribute("role","presentation"),h(t,"position","fixed"),h(t,"inset","0px"),h(t,"width","100vw"),h(t,"height","100vh"),h(t,"margin","0px"),h(t,"padding","0px"),h(t,"border","0px"),h(t,"background","rgb(0, 0, 0)"),h(t,"opacity","1"),h(t,"pointer-events","auto"),h(t,"cursor","none"),h(t,"z-index","2147483647");let e=!u;t.hidden!==e&&(t.hidden=e);let n=u?"on":"off";return t.dataset.state!==n&&(t.dataset.state=n),t}function O(t){u=t;let e=o.ROOT_DOC.documentElement;e.hasAttribute(d)!==t&&e.toggleAttribute(d,t),t&&o.ROOT_DOC.body?.classList.remove("lia-tff-panel-open"),g()}function y(t){let e=function(t){for(let e of f())for(let n of Array.from(e.querySelectorAll("#"+t))){let t=n.closest("main");if(!(t?.hasAttribute("hidden")||n.closest("[inert]"))&&!n.matches(":disabled, [aria-disabled=true], .is-disabled")&&"function"==typeof n.click)return n}return null}(t);return!!e&&(e.click(),!0)}function b(t){let e;if((0,s.isEditableKeyboardEvent)(t))return;let n=u&&"Escape"===t.key?"close-blackout":t.defaultPrevented||t.isComposing||t.ctrlKey||t.altKey||t.metaKey?null:t.shiftKey||"PageDown"!==t.key&&"PageDown"!==t.code?t.shiftKey||"PageUp"!==t.key&&"PageUp"!==t.code?(t.shiftKey||"."!==t.key&&"Period"!==t.code)&&"KeyB"!==t.code&&"b"!==String(t.key||"").toLowerCase()?null:"toggle-blackout":"previous":"next";if(!n)return;let i=u&&("toggle-blackout"===n||"close-blackout"===n);"close-blackout"!==n&&!m("unknown"!==(e=(0,l.detectMode)())?e:o.CONTENT_DOC.documentElement.dataset.liaMode||"unknown")||!i&&((0,s.eventPathMatches)(t,"dialog, [role=dialog], .lia-modal")||f().some(t=>!!t.querySelector(".lia-modal, dialog[open], [role=dialog][aria-modal=true]")))||(t.preventDefault(),t.stopImmediatePropagation(),!t.repeat&&("next"===n?((0,a.cancelReverseEntry)(),y("lia-btn-next")):"previous"===n?((0,a.armReverseEntry)(),y("lia-btn-prev")||(0,a.cancelReverseEntry)()):"close-blackout"===n?O(!1):O(!u)))}function T(){if(!p)for(let t of(p=!0,g(),f()))t.addEventListener("keydown",b,!0)}function _(t){g(),u&&!m(t)&&O(!1)}},{"./state":"jPEty","./mode":"aGLfG","./reverseNavigation":"lCNcT","./keyboard":"5sy7j","@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],lCNcT:[function(t,e,n,i){var r=t("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"cancelReverseEntry",()=>y),r.export(n,"armReverseEntry",()=>_),r.export(n,"initReverseNavigation",()=>C),r.export(n,"syncReverseNavigation",()=>E);var o=t("./state"),l=t("./mode"),a=t("./keyboard");let s="lia-btn-prev",c=!1,d=!1,p=null,u=null;function f(){return o.ROOT_DOC===o.CONTENT_DOC?[o.CONTENT_DOC]:[o.CONTENT_DOC,o.ROOT_DOC]}function m(t){let e=String(t||"").trim().toLowerCase();return"presentation"===e||"slides"===e}function h(){let t=(0,l.detectMode)();return"unknown"!==t?t:o.CONTENT_DOC.documentElement.dataset.liaMode||"unknown"}function g(){for(let t of f())for(let e of Array.from(t.querySelectorAll(".lia-pagination__current"))){if(e.closest("[hidden], [inert]"))continue;let n=e.closest(".lia-pagination");if(!n?.querySelector("#"+s))continue;let i=String(e.textContent||"").trim().match(/^\s*(\d+)(?:\s*\(\s*(\d+)\s*\/\s*(\d+)\s*\))?\s*$/);if(!i)continue;let r=Number(i[1]),o=null==i[2]?0:Number(i[2]),l=null==i[3]?0:Number(i[3]);if(Number.isInteger(r)&&Number.isInteger(o)&&Number.isInteger(l)&&!(r<1)&&!(o<0)&&!(l<0)&&!(o>l))return{doc:t,slide:r,visible:o,effects:l}}return null}function O(t,e){for(let n of[t,...f().filter(e=>e!==t)])for(let t of Array.from(n.querySelectorAll("#"+e)))if(!t.closest("[hidden], [inert]")&&!t.matches(":disabled, [aria-disabled=true], .is-disabled")&&"function"==typeof t.click)return t;return null}function y(){p=null,null!=u&&(o.ROOT_WIN.clearTimeout(u),u=null)}function b(){p&&null==u&&(u=o.ROOT_WIN.setTimeout(()=>{u=null,E(h()),p&&b()},25))}function T(){return f().some(t=>!!t.querySelector(".lia-modal, dialog[open], [role=dialog][aria-modal=true]"))}function _(){if(!m(h())||T())return void y();let t=g();!t||0!==t.visible||t.slide<=1?y():(p={fromSlide:t.slide,targetSlide:t.slide-1,sawTargetReset:!1,targetZeroSince:null,awaitingVisible:null,zeroEffectsSince:null,deadline:Date.now()+2500},b())}function x(t){if(t.isComposing||(0,a.isEditableKeyboardEvent)(t))return;let e=String(t.key||""),n=e.toLowerCase(),i="ArrowLeft"===e&&!t.ctrlKey&&!t.altKey&&!t.metaKey&&!t.shiftKey,r=t.altKey&&t.shiftKey&&"p"===n;if("ArrowRight"===e||t.altKey&&t.shiftKey&&"n"===n)return void y();if(!T()){if(i&&t.repeat&&p){t.preventDefault(),t.stopImmediatePropagation();return}if(i){let e,n=g();if(!(m(h())&&n&&0===n.visible&&n.slide>1)||!n)return void y();if(t.preventDefault(),t.stopImmediatePropagation(),t.repeat)return;return _(),void((!(e=O(n.doc,s))||(e.click(),0))&&y())}!t.repeat&&r&&_()}}function v(t){if(d)return;let e=t.target;e&&"function"==typeof e.closest&&(e.closest("#"+s)?_():p&&y())}function C(){if(!c)for(let t of(c=!0,f()))t.addEventListener("keydown",x,!0),t.addEventListener("click",v,!0)}function E(t){if(!p)return;if(!m("unknown"===t?h():t)||T()||Date.now()>p.deadline)return void y();let e=g();if(!e||e.slide===p.fromSlide)return void b();if(e.slide!==p.targetSlide)return void y();if(!p.sawTargetReset){if(0!==e.visible){p.targetZeroSince=null,b();return}if(null==p.targetZeroSince&&(p.targetZeroSince=Date.now()),Date.now()-p.targetZeroSince<250)return void b();p.sawTargetReset=!0}if(null!=p.awaitingVisible){if(e.visible<p.awaitingVisible)return void b();p.awaitingVisible=null,p.deadline=Date.now()+2500}0===e.effects?(null==p.zeroEffectsSince&&(p.zeroEffectsSince=Date.now()),Date.now()-p.zeroEffectsSince<750)?b():y():(p.zeroEffectsSince=null,e.visible>=e.effects)?y():(p.awaitingVisible=e.visible+1,function(t){let e=O(t.doc,"lia-btn-next");if(!e)return!1;d=!0;try{e.click()}finally{d=!1}return!0}(e)?p.deadline=Date.now()+2500:p.awaitingVisible=null,b())}},{"./state":"jPEty","./mode":"aGLfG","./keyboard":"5sy7j","@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],a2N0z:[function(t,e,n,i){var r=t("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"AUTOSCROLLING_MARKER_ATTR",()=>l),r.export(n,"syncAutoscrolling",()=>f);var o=t("./state");let l="data-lia-tff-autoscrolling",a="__LIA_TFF_AUTOSCROLLING_GUARD_V2__",s=`[${l}]`,c=null;function d(t){return"off"!==String(t||"").trim().toLowerCase()}function p(t,e){var n;let i,r,o,a=(o=(r=(i=e.parentElement||e)===e?[e]:Array.from(i.children).filter(t=>"main"===t.localName)).includes(e)?r:[e],c&&c.doc===t&&c.root===i&&(n=c.slides,n.length===o.length&&n.every((t,e)=>t===o[e]))||(c={doc:t,root:i,slides:o,settings:new Map}),c);for(let t of a.slides){let n=function(t){return Array.from(t.querySelectorAll(s)).filter(e=>e.closest("main")===t)}(t),i=n[n.length-1];i?a.settings.set(t,d(i.getAttribute(l))):t===e&&a.settings.delete(t)}let p=a.slides.indexOf(e),u=function(t){let e=!0;for(let n of Array.from(t.querySelectorAll(s)))n.closest("main")||(e=d(n.getAttribute(l)));return e}(t);for(let t=0;t<=p;t+=1){let e=a.settings.get(a.slides[t]);void 0!==e&&(u=e)}return u}function u(t){return t.querySelector("main.lia-slide__content:not([hidden])")||t.querySelector("main:not([hidden])")}function f(){let t=Array.from(o.CONTENT_DOC.querySelectorAll("#focused")).find(t=>t.closest("main:not([hidden])"))||null,e=t?.closest("main:not([hidden])")||u(o.CONTENT_DOC);e&&p(o.CONTENT_DOC,e),t&&function(t){let e=t[a],n=e&&"object"==typeof e?e:null;if(n&&t.scrollIntoView===n.wrappedScrollIntoView)return;let i=t.scrollIntoView;if("function"!=typeof i)return;let r=function(t){let e=this.closest("main:not([hidden])")||u(this.ownerDocument);(!e||p(this.ownerDocument,e))&&(void 0===t?i.call(this):i.call(this,t))};try{Object.defineProperty(t,"scrollIntoView",{configurable:!0,writable:!0,value:r}),n?n.wrappedScrollIntoView=r:Object.defineProperty(t,a,{configurable:!0,value:{wrappedScrollIntoView:r}})}catch(t){}}(t)}},{"./state":"jPEty","@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}]},["8RSWf"],"8RSWf","parcelRequirec2a1",{});
